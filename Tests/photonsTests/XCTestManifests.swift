...
extension FutureResultsTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FutureResultsTests = [
        ("testFutureFlatMappingWithErrorValue", testFutureFlatMappingWithErrorValue),
        ("testFutureFlatMappingWithResultValue", testFutureFlatMappingWithResultValue),
        ("testFutureMappingWithErrorValue", testFutureMappingWithErrorValue),
        ("testFutureMappingWithResultValue", testFutureMappingWithResultValue),
        ("testFutureWithErrorValue_OnSubscribeSuccessErrorFunction", testFutureWithErrorValue_OnSubscribeSuccessErrorFunction),
        ("testFutureWithResultError", testFutureWithResultError),
        ("testFutureWithResultValue", testFutureWithResultValue),
        ("testFutureWithResultValue_OnSubscribeSuccessErrorFunction", testFutureWithResultValue_OnSubscribeSuccessErrorFunction),
        ("testFutureZippingWithErrorValue", testFutureZippingWithErrorValue),
        ("testFutureZippingWithResultValue", testFutureZippingWithResultValue),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FutureResultsTests.__allTests__FutureResultsTests),
